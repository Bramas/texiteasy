...
DialogKeySequence::DialogKeySequence(QWidget *parent)
...
DialogKeySequence::~DialogKeySequence()
{
}

bool DialogKeySequence::eventFilter(QObject *o, QEvent *e)
{
...
void DialogKeySequence::slotClearShortcut()
{
...
void DialogKeySequence::handleKeyEvent(QKeyEvent *e)
{
    int nextKey = e->key();
...
void DialogKeySequence::setKeySequence(const QKeySequence &sequence)
{
...
QKeySequence DialogKeySequence::keySequence() const
{
    return m_keySequence;
}

int DialogKeySequence::translateModifiers(Qt::KeyboardModifiers state, const QString &text) const
{
    int result = 0;
...
void DialogKeySequence::focusInEvent(QFocusEvent *e)
{
    ui.lineEdit->event(e);
...
void DialogKeySequence::focusOutEvent(QFocusEvent *e)
{
    m_num = 0;
    ui.lineEdit->event(e);
...
bool DialogKeySequence::event(QEvent *e)
{
