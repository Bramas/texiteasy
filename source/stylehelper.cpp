...
static void verticalGradientHelper(QPainter *p, const QRect &spanRect, const QRect &rect, bool lightColored)
{
    ...
    grad.setColorAt(0, StyleHelper::highlightColor(lightColored).lighter(120));
    grad.setColorAt(0.9, StyleHelper::highlightColor(lightColored));
    grad.setColorAt(0.901, base);
    grad.setColorAt(1, StyleHelper::shadowColor(lightColored));
