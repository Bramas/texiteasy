...
GitHelper::GitHelper(QString filename)
{
    QStringList args;
    args << "diff";
    ...
    //add svn to path
    QString extraPath = ConfigManager::Instance.gitPath();
    QProcessEnvironment env = QProcessEnvironment::systemEnvironment();
    _process.setWorkingDirectory(QFileInfo(filename).dir().absolutePath());
#ifdef OS_WINDOWS
